...
Route::prefix('v1')->group(function () {
    ...
    Route::group(['namespace' => 'Api\\V1\\'], function () {
        ...
        Route::prefix('meal-categories')->group(function () {
            ...
            Route::patch('{mealCategory}', 'MealCategoryController@update')->middleware(['role:producer_admin', 'can:ifCompanyId,mealCategory']);
        ...
        Route::prefix('meals')->group(function () {
            ...
            Route::patch('{meal}', 'MealController@update')->middleware(['role:producer_admin', 'can:ifCompanyId,meal']);
        ...
        Route::prefix('orders')->group(function () {
            ...
            Route::patch('producer-update-status/{order}', 'OrderController@producerUpdateStatus')->middleware('role:producer_admin,producer_user', 'can:ifCompanyId,order');
            Route::patch('cancel/{order}', 'OrderController@cancel')->middleware('can:cancel,order');
