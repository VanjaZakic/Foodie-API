...
CREATE TABLE `users` (
    ...
    `role` ENUM('admin', 'producer_admin', 'producer_user', 'customer_admin','customer_user','user') NOT NULL,
    `created_at` datetime NOT NULL,
    `updated_at` datetime NOT NULL,
    `deleted_at`  datetime NOT NULL,
...
CREATE TABLE `meal_categories` (
    ...
    `user_role` ENUM('admin', 'producer_admin', 'producer_user', 'customer_admin','customer_user','user') NOT NULL,
    PRIMARY KEY(`id`),
    UNIQUE KEY (`name`),
